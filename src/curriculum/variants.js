...
export const VARIANTS=[
  ...
  V('cti-desc-pass','chord-tones-in-time','GROW',[N('Bb4',70,0,.5),N('A4',69,.5,.5),N('G4',67,1,.5),N('F4',65,1.5,.5),N('E4',64,2,.5),N('D4',62,2.5,.5),N('C4',60,3,.5),N('Bb3',58,3.5,.5)],{parentVariant:'cti-desc-seed',morphType:'INSERT',morphTargets:[1,3,5,7],allowedPresentation:LEARN,allowedHarmony:['C7'],source:H001}),
