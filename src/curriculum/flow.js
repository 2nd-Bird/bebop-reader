...
export function buildClosingFlowEvent({musicalForm,startBeat,endBeat,key='C',bpm=60,eventId='flow-closing'}={}){
  ...
  return{
    ...
    flowAction:'CONNECT',scoreVisibility:'FULL',flowSourceVariantIds:[...program.variantIds],
