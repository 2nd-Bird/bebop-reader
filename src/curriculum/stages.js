export const STAGES = [
  ...
  { stage: 5, id: 'rehear-the-note', title: 'Rehear the Note', unlock: { notes: ['F4','G4'], rhythm: ['half'], harmony: ['FMaj7','G7sus4'] }, field: 'training-4', gate: 'sing the same G→F while hearing G first as an ornament toward F, then as the root of G7sus4' },
];
