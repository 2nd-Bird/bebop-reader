export const STAGES = [
  ...
  { stage: 2, id: 'tonic-shape', title: 'Tonic Shape', unlock: { notes: ['C4','E4','G4','C5'], rhythm: ['quarter','half'] }, field: 'training-4', gate: 'C–E–Gを一音ずつではなく、一つのshapeとして読める' },
  { stage: 3, id: 'make-the-line', title: 'Make the Line', unlock: { notes: ['B3','C4','D4','E4','F4','G4'], rhythm: ['quarter','eighth-pair','rest'] }, field: 'training-4', gate: 'Tonic Shapeに音が加わっても、一つの線として読んで歌える' },
