export const STAGES = [
  ...
  { stage: 8, id: 'ornament-direction', title: 'Ornament as Direction', unlock: { notes: ['B3','C4','C#4','D4','D#4','E4','F4','G4','A4','B4'], rhythm: ['quarter','eighth-pair'], transform: ['passing','neighbor','appoggiatura','turn','chromatic-approach'] }, field: 'training-4', gate: '装飾音が増えても、どこへ向かうlineかを失わず普通の譜面からcold readできる' },
];
