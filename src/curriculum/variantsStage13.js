...
const MIDI={G4:67,A4:69,Bb4:70,B4:71,'F#4':66,F4:65,D5:74};
...
export const STAGE13_VARIANTS=[
  ...
  V('density-gf-arpeggio','DENSIFY',[N('G4',67,0,1),N('B4',71,1,1),N('D5',74,2,1),N('F4',65,3,1)],{parentVariant:'density-gf-seed',morphType:'DENSIFY',morphTargets:[0,1,2,3],allowedPresentation:LEARN,densityLevel:1,surfaceType:'ARPEGGIATE'}),
